...
public class EmployeeController {
  ...
  public ResponseEntity<EmployeeModel> getEmployee(@PathVariable UUID id) {
    final Employee employeeEntity = service
      .findById(id)
  ...
  public ResponseEntity<EmployeeModel> replaceEmployee(@PathVariable UUID id, @RequestBody EmployeeDTO employeeDTO) {
    final Optional<Employee> originalEmployee = service.findById(id);
    final Employee saved = originalEmployee
      .map(employee -> {
